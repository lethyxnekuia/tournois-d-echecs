...
class HomeMenuController:
    ...
    def __init__(self):
        ...
        self.tournament_menu_controller = tournament_controller.TournamentMenuController(
            [],
            self.player_menu_controller.players
        )
        self.save_and_load_menu_controller = save_and_load_controller.SaveAndLoadMenuController(
            self.player_menu_controller.players,
            self.tournament_menu_controller.tournaments
        )
        self.main_menu = {
            ...
            "4": {"label": "Quitter", "action": self.stop}
        }
